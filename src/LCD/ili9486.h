...
/* -------------------------------------------------------------------------
 * Command codes (from ILI9486 datasheet §8)
 * ---------------------------------------------------------------------- */
...
#define MADCTL_MV   0x20  /* Row/column exchange:  0=normal,     1=swapped (landscape) */
#define MADCTL_ML   0x10  /* Vertical refresh:     0=top→bottom, 1=bottom→top */
#define MADCTL_BGR  0x08  /* Color order:          0=RGB,        1=BGR */
#define MADCTL_MH   0x04  /* Horizontal refresh:   0=left→right, 1=right→left */

/* Default orientation: portrait, RGB panel */
 ...
 * ---------------------------------------------------------------------- */
#define COLMOD_16BPP  0x55  /* DPI=101 (16bpp), DBI=101 (16bpp) */
#define COLMOD_18BPP  0x66  /* DPI=110 (18bpp), DBI=110 (18bpp) */
