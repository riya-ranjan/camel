// Phase 2: Enable Unicam power domain + CAM1 clock, verify register access.
#include "rpi.h"
#include "mbox.h"
#include "cam-power.h"
#include "i2c.h"
...
void notmain(void) {
    ...
    // 1. Power on camera (reuse Phase 1).
    cam_power_on();
    output("Camera powered on.\n");

    // 2. Verify IMX477 still responds over I2C.
