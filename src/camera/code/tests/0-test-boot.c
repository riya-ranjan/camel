// Phase 0: verify the Pi boots with new firmware (start_x.elf, gpu_mem=128).
// Runs the same mailbox queries as test-mbox.c.
// Pass: prints board info over UART.
// Fail: no output or panic.
#include "rpi.h"
#include "mbox.h"
